export const FEEDS: Record<string, { name: string; url: string }[]> = {
  ...
  ko: [
    { name: 'Google 뉴스 – 주요 뉴스', url: 'https://news.google.com/rss?hl=ko&gl=KR&ceid=KR:ko' },
    { name: 'Google 뉴스 – 국제', url: 'https://news.google.com/rss/headlines/section/topic/WORLD?hl=ko&gl=KR&ceid=KR:ko' },
  ...
  ja: [
    { name: 'Google ニュース – トップ', url: 'https://news.google.com/rss?hl=ja&gl=JP&ceid=JP:ja' },
    { name: 'Google ニュース – 国際', url: 'https://news.google.com/rss/headlines/section/topic/WORLD?hl=ja&gl=JP&ceid=JP:ja' },
    ...
    { name: '共同通信（英語）', url: 'https://english.kyodonews.net/rss/news.xml' },
    { name: 'Japan Times', url: 'https://www.japantimes.co.jp/news/rss' },
    { name: '日経', url: 'https://asia.nikkei.com/rss/feed/nar' },
    { name: '読売', url: 'https://www.yomiuri.co.jp/rss/yol_all.rdf' },
    { name: '産経', url: 'https://www.sankei.com/rss/news/flash.xml' },
    { name: 'NHK World (EN)', url: 'https://www3.nhk.or.jp/nhkworld/en/news/rss/' }
  ],
  fr: [
    { name: 'Google Actualités – À la une', url: 'https://news.google.com/rss?hl=fr&gl=FR&ceid=FR:fr' },
    { name: 'Google Actualités – Monde', url: 'https://news.google.com/rss/headlines/section/topic/WORLD?hl=fr&gl=FR&ceid=FR:fr' },
